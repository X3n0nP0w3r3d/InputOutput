...
/** another parity question as usual
 * 3 submissions last AC
 * observations:
 * A can only win against B if n is odd and parity is the same, 
 * if n is even then A can only win if the parity is same
 * otherwise B wins and it is not possible to win as A
 * 
*/
