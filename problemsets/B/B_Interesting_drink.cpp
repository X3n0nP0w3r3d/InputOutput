...
// AC - solution matches LGMs and GMs wow
void solve() {
    // #ifndef LOCAL
    ...
    FOR(q){
        ...
        //     if(a >= c)cnt++;
        // }
        // cout << distance(s.begin(), upper_bound(all(s), a)) << "\n";
        cout << upper_bound(all(s), a) - s.begin() << "\n"; // can just minus begin iterator instead of using distance
    }
}
