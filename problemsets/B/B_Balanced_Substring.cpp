...
//     string s;
//     read(n, s);
//     vt<int> minI(n*2+1, INF);
//     vt<int> maxI(n*2+1, -INF);
...
//     FOR(n){
//         dep += (s[i]=='1' ? 1 : -1);
//         minI[dep+n] = min(minI[dep+n], i);
//         maxI[dep+n] = max(maxI[dep+n], i);
//     }
//     FOR(n*2+1){
//         len = max(len, maxI[i] - minI[i]);
//     }
//     cout << len;
// }

// https://codeforces.com/contest/873/submission/31243795
void solve(){
    int n;
	cin >> n;
