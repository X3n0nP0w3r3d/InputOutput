...
//     // #endif
//     // first attempt didn't account for matching exact amnt of character woops. plz rtfq!1!!1
//     string g;
//     string h;
//     string s;
//     map<char, int> s_cnt;
...
//         o_cnt[c]++;
//     }
//     if(sza(s_cnt) == sza(o_cnt)){
//         for(auto entry : o_cnt){
//             if(entry.second != s_cnt[entry.first]){
//                 ynw(0);
//                 return;
//             }
//         }
