...
// failed tc 8 after hacks lol was bugged up asf glad i knew i was retarded so unrated register eckss dee
// apparently i just compared size of m to k instead of k==n wow
void solve() {
    // #ifndef LOCAL
    ...
    FOR(m){
       if(a.count(qle[i]) && n!=sza(a) || sza(a) < n-1)cout<<0;
       else cout<< 1;
    }
    cout << "\n";
}

// better version using bitset
bitset<300010> knows;
void solveFIX(){
    int n,m,k;
    read(n,m,k);
