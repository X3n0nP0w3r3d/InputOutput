...
void solve() {
    ...
    read(n,m);
    int mxmoves = min(n,m);
    //mxmoves%2==0 ? cout << "Malvika" : cout << "Akshat"; // original solution (very fast)
    mxmoves & 1 ? cout << "Akshat" : cout << "Malvika"; // bitwise ops ver OMGGGG!!!11!! (odd numbers always have a 1 in binary wow)
}
