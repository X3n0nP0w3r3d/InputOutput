...
// better optimised solution using inclusion-exclusion principle: P(A)+P(B)-P(AnB)
// removes duplicate counts by finding lcm of sets (intersection)
// we know that floor(D/T) dragons satisfy a given condition (Tth dragon of D dragons)
void solve(){
    int k,l,m,n,d;
    cin >> k >> l >> m >> n >> d;
    int init_cnt = d/k + d/l + d/m + d/n;
}
