...
void solve() {
    ...
    int n;
    cin >> n;
    // count number of odds and evens (if we assume we can find eveness by which index is lesser we will be hit by edge cases lol [first or last number is different])
    int oc=0;
    int ec=0;
    int o=0;
    int e=0;
