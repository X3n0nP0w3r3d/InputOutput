...
// solved looking at https://codeforces.com/contest/189/submission/20790014
// the 0xACC blah blah thing is a random negative number that is large (represents impossible state by making total return negative)
// int f(int x){
//         if(x==0) return 0;
//         if(x < 0 || (x > 0 && x < min(a, min(b,c))) ) return -1e9;
