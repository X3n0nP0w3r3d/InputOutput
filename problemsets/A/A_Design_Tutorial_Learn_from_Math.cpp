...
/**
 * Main points:
 * if k is odd print n-9 and 9
 * otherwise print n-8 and 8
 * 
 * realise that 9 is the first composite odd number
 * even numbers can just print any even pair of numbers e.g. n-2 and 2 or n-8 and 8
 */
void solve() {
    // #ifndef LOCAL
