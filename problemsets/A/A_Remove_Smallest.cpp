...
/**
 * ecnerwala soln
 * uses a set, gets the min val of set and minus from max val of set
 * compares size of set to diff to decide what to print
 * 
 * #include<bits/stdc++.h>
...
int main() {
	...
	while (T--) {
		...
		cout << (int(A.size()) == *A.rbegin() - *A.begin() + 1 ? "YES" : "NO") << '\n';
	}
