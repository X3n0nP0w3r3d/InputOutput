...
int main() {
    ...
    // long winded initial solution, there is a more efficient way than doing this
    // using exterior angles in regular polygons add up to 360, n*(180-a)=360
    // although the question didn't mention exterior or interior, should've considered this
    // hence 360%(180-a) must be 0 in order for a to satisfy the above condition
