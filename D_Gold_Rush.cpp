...
// read tutorial since failing tc2 (as expected) since initial approach consisted of 2 while loops checking a/3 and a/3 * 2 for finding m
// tutorial approach consisted of recursion (i was thinking this was needed after using 2 while loops)
// checks recursively whether a(initial pile) == b(target)
// if the initial pile isn't divisble by 3 then impossible to get target;
// otherwise check a/3 and 2*(a/3) (just like two while loops without shittiness)
