...
void solve() {
    ...
    int i = 0;
    while(i<sza(s)){
        //if(s.substr(i, 6)=="dreamer" && s.substr(i+5, 5)!="erase" || s.substr(i, 6)=="eraser" && s.substr(i+4, 5)!="erase"){
        if(s.substr(i, 7)=="dreamer" && s.substr(i+5, 5)!="erase"){
            i+=7;
            continue;
        }
        ...
        if(s.substr(i, 5)=="erase" || s.substr(i, 5)=="dream"){
            i+=5;
            continue;
        }
        ynw(0);
