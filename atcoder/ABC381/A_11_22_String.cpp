...
// instead of implementing literally from given constraints, should've thought about what it implied aka even sides and one slash separating the 1s from 2s
// much more easier to approach from this
void solve() {
    // #ifndef LOCAL
