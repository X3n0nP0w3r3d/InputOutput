...
void solve() {
    ...
    // apparently this method will TLE and the observation is that perfect squares have an odd amount of divisors
    // even number of divisors for perfect squares so check if number is perfect square, if so it will be off otherwise on
