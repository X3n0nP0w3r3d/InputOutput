...
/** 
 * idk why such trivial problem took me so fucking long to figure out
 * sort both arrays
 * check if abs diff is equal to or less than k
 * if a[i] is greater than b[i] increment apt pointer
 * otherwise increment ppl pointer
 */
void solve() {
    // #ifndef LOCAL
