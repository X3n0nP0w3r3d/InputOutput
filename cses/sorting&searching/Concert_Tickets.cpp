...
/**
 * im actually shit at these questions wtf
 * im supposed to use a multiset to store the tickets and use UPPER BOUND to check whether the index that is greater than
 * the max ticket price is the beginning of the array (all elements are above max price) in which case it is impossible to give a ticket
 * or just print the index before the upper bound index
 */
void solve() {
    // #ifndef LOCAL
